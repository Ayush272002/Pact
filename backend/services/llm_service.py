        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                ...
                (
                    ...
                    "NEGATIVE values (-0.1 to -0.5) for hostile/aggressive moves.\n\n"
                    "2. treaty_updates: If you are proposing SPECIFIC NUMBERS that change the treaty, "
                    "you MUST include them in treaty_updates.issue_updates.\n"
                    "   - Use ONLY these issue keys: {issues_str}\n"
                    "   - Percentages as decimals: 40% -> 0.40, 8% -> 0.08\n"
                    "   - Booleans as true/false\n"
                    "   - Example: {{\"issue_updates\": {{\"revenue_share\": 0.40, \"protected_zones\": 0.25}}}}\n\n"
                    "3. DO NOT put raw numbers in game_move.numeric_proposal. "
                    "Use treaty_updates.issue_updates instead.\n\n"
                    "4. Your 'content' text should describe your position in natural language. "
                    "The structured data goes in treaty_updates.\n\n"
                    "{format_instructions}",
                ),
            ]
        )
